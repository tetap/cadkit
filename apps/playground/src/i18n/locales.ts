...
const zh: Record<MessageKey, string> = {
  ...
  engraveFill: '填充雕刻',
  engraveImage: '图像图层',
  engraveImageHint: '导出为灰度 PWM 扫描雕刻（按深浅调功率）。图片只能放在图像图层。',
  imageScanHint: '扫描线间距：建议 0.05–0.1 mm；越小越细，文件也越大。',
  lineSpacing: '线间距',
  fillStyle: '填充路径样式',
...
const en: Record<MessageKey, string> = {
  ...
  engraveImageHint: 'Grayscale PWM scan engraving (power follows tone). Images stay on image layers only.',
  imageScanHint: 'Scanline pitch: try 0.05–0.1 mm; smaller = finer detail and larger G-code.',
