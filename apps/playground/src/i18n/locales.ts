...
const zh: Record<MessageKey, string> = {
  ...
  engraveFill: '填充雕刻',
  engraveImage: '图像图层',
  engraveImageHint: '灰度按功率雕刻；阈值/抖动为黑白两档。滤镜会参与导出；仅透明空走。',
  imageScanHint: '扫描线间距：建议 0.08–0.15 mm；过密会文件巨大。',
  lineSpacing: '线间距',
  fillStyle: '填充路径样式',
...
const en: Record<MessageKey, string> = {
  ...
  engraveImageHint: 'Grayscale uses variable S; threshold/Floyd are binary. Filters apply to export; travel only on transparency.',
  imageScanHint: 'Scanline pitch: try 0.08–0.15 mm; denser means larger files.',
