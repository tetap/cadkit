...
const zh: Record<MessageKey, string> = {
  ...
  engraveFill: '填充雕刻',
  engraveImage: '图像图层',
  engraveImageHint: '灰度 PWM 扫描：深色高功率，近白跳过。图片只能放在图像图层。',
  imageScanHint: '扫描线间距：建议 0.08–0.15 mm；过密会文件巨大且预览发糊。',
  lineSpacing: '线间距',
  fillStyle: '填充路径样式',
...
const en: Record<MessageKey, string> = {
  ...
  engraveImageHint: 'Grayscale PWM: dark→high S, near-white skipped. Images stay on image layers only.',
  imageScanHint: 'Scanline pitch: try 0.08–0.15 mm; denser means huge files and muddy previews.',
