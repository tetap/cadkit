  ...
  locales: {
    root: {
      ...
      themeConfig: {
        ...
        langMenuLabel: '切换语言',
        socialLinks: [{ icon: 'github', link: 'https://github.com/leaferjs/leafer-ui' }],
      },
    },
    en: {
      label: 'English',
      lang: 'en-US',
      link: '/en/',
      description: 'Industrial CAD infinite-canvas editor framework',
      themeConfig: {
        nav: enNav,
        sidebar: enSidebar,
